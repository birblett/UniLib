...
if Reborn
  ...
  PARAS_AEVIAN = PokeModifier.add_form(:PARAS, "Aevian Form")
              ...
              .set_ev([0, 1, 0, 0, 0, 0])
              .set_evolutions(proc { [{:species => :PARASECT, :method => :Item, :parameter => :XENWASTE, :form => PARASECT_AEVIAN}] })
  ...
  ItemBuilder.add(:XENWASTE, "Xen Waste", "Industrial waste created during Team Xen's experiments. It seems to cause Pokemon to mutate...")
             .no_use
             .no_use_in_battle
             .evo_item
  ...
  PARASECT_AEVIAN = PokeModifier.add_form(:PARASECT, "Aevian Form")
              ...
              .abilities({0 => :RESUSCITATION, 1 => nil, 2 => :RESUSCITATION})
              .set_ev([0, 2, 1, 0, 0, 0])
              .set_preevo(proc { {:species => :PARAS, :form => PARAS_AEVIAN} })
  ...
  MAGIKARP_AEVIAN = PokeModifier.add_form(:MAGIKARP, "Aevian Form")
              ...
              .abilities({0 => :RATTLED, 1 => :MAGMAARMOR, 2 => :RATTLED})
              .set_ev([0, 0, 0, 0, 0, 1])
              .set_evolutions(proc { [{:species => :GYARADOS, :method => :Level, :parameter => 20, :form => GYARADOS_AEVIAN}] })
  ...
  GYARADOS_AEVIAN = PokeModifier.add_form(:GYARADOS, "Aevian Form")
              ...
              .set_ev([0, 2, 0, 0, 0, 0])
              .set_preevo(proc { {:species => :MAGIKARP, :form => MAGIKARP_AEVIAN} })
  ...
  MAREEP_AEVIAN = PokeModifier.add_form(:MAREEP, "Aevian Form")
              ...
              .set_ev([0, 0, 0, 1, 0, 0])
              .set_evolutions(proc { [{:species => :FLAAFFY, :method => :Level, :parameter => 15, :form => FLAAFFY_AEVIAN}] })
  ...
  AMPHAROS_AEVIAN = PokeModifier.add_form(:AMPHAROS, "Aevian Form")
              ...
              .abilities({0 => :FILTER, 1 => :COTTONDOWN, 2 => :FILTER})
              .set_ev([0, 0, 0, 3, 0, 0])
              .set_preevo(proc { {:species => :FLAAFFY, :form => FLAAFFY_AEVIAN} })
  ...
  SHROOMISH_AEVIAN = PokeModifier.add_form(:SHROOMISH, "Aevian Form")
              ...
              .abilities({0 => :RATTLED, 1 => :TECHNICIAN, 2 => :STATIC})
              .set_ev([1, 0, 0, 0, 0, 0])
              .set_evolutions(proc { [{:species => :BRELOOM, :method => :Level, :parameter => 23, :form => BRELOOM_AEVIAN}] })
  ...
  BRELOOM_AEVIAN = PokeModifier.add_form(:BRELOOM, "Aevian Form")
              ...
              .abilities({0 => :TOUGHCLAWS, 1 => :TECHNICIAN, 2 => :STATIC})
              .set_ev([0, 2, 0, 0, 0, 0])
              .set_preevo(proc { {:species => :SHROOMISH, :form => SHROOMISH_AEVIAN} })
  ...
  MoveBuilder.add(:WAKEUPSHOCK, "Wake Up Shock", "This attack inflicts big damage on a sleeping target. It also wakes the target up. ",
                  :ELECTRIC, :physical, 10, 80, 100, 0x07D)
             .flag(:contact, true)
             .flag(:kingrock, true)
  ...
  ROSELIA_AEVIAN = PokeModifier.add_form(:ROSELIA, "Aevian Form")
              ...
              .abilities({0 => :DRYSKIN, 1 => :TECHNICIAN, 2 => :SANDVEIL})
              .set_ev([0, 0, 0, 2, 0, 0])
              .set_evolutions(proc { [{:species => :ROSERADE, :method => :Item, :parameter => :SUNSTONE, :form => ROSERADE_AEVIAN}] })
  ...
  FEEBAS_AEVIAN = PokeModifier.add_form(:FEEBAS, "Aevian Form")
              ...
              .abilities({0 => :POISONPOINT, 1 => :STENCH, 2 => :SCRAPPY})
              .set_ev([0, 0, 0, 0, 0, 1])
              .set_evolutions(proc { [{:species => :MILOTIC, :method => :TradeItem, :parameter => :PRISMSCALE, :form => MILOTIC_AEVIAN}] })
  ...
  MILOTIC_AEVIAN = PokeModifier.add_form(:MILOTIC, "Aevian Form")
              ...
              .set_ev([0, 0, 0, 0, 2, 0])
              .set_preevo(proc { {:species => :FEEBAS, :form => FEEBAS_AEVIAN} })
  ...
  SNORUNT_AEVIAN = PokeModifier.add_form(:SNORUNT, "Aevian Form")
              ...
              .abilities({0 => :GRASSPELT, 1 => :ROCKHEAD, 2 => :STAMINA})
              .set_ev([1, 0, 0, 0, 0, 0])
              .set_evolutions(proc { [{:species => :GLALIE, :method => :Level, :parameter => 42, :form => GLALIE_AEVIAN}, {:species => :FROSLASS, :method => :ItemFemale, :parameter => :WATERSTONE, :form => FROSLASS_AEVIAN}] })
  ...
  GLALIE_AEVIAN = PokeModifier.add_form(:GLALIE, "Aevian Form")
              ...
              .set_ev([2, 0, 0, 0, 0, 0])
              .set_preevo(proc { {:species => :SNORUNT, :form => SNORUNT_AEVIAN} })
  ...
  BUDEW_AEVIAN = PokeModifier.add_form(:BUDEW, "Aevian Form")
              ...
              .abilities({0 => :DRYSKIN, 1 => :TECHNICIAN, 2 => :SANDVEIL})
              .set_ev([0, 0, 0, 1, 0, 0])
              .set_evolutions(proc { [{:species => :ROSELIA, :method => :HappinessDay, :parameter => 0, :form => ROSELIA_AEVIAN}] })
  ...
  ROSERADE_AEVIAN = PokeModifier.add_form(:ROSERADE, "Aevian Form")
              ...
              .abilities({0 => :DRYSKIN, 1 => :TECHNICIAN, 2 => :SANDVEIL})
              .set_ev([0, 0, 0, 3, 0, 0])
              .set_preevo(proc { {:species => :ROSELIA, :form => ROSELIA_AEVIAN} })
  ...
  SHELLOS_WEST_AEVIAN = PokeModifier.add_form(:SHELLOS, "West Aevian Form")
              ...
              .set_ev([1, 0, 0, 0, 0, 0])
              .set_evolutions(proc { [{:species => :GASTRODON, :method => :Level, :parameter => 30, :form => GASTRODON_WEST_AEVIAN}] })
  ...
  SHELLOS_EAST_AEVIAN = PokeModifier.add_form(:SHELLOS, "East Aevian Form")
              ...
              .compatible_moves_overwrite
              .types({:Type1 => :GROUND, :Type2 => :FAIRY})
              .abilities({0 => :STORMDRAIN, 1 => :LIQUIDOOZE, 2 => :FLAREBOOST})
              .set_ev([1, 0, 0, 0, 0, 0])
              .set_evolutions(proc { [{:species => :GASTRODON, :method => :Level, :parameter => 30, :form => GASTRODON_EAST_AEVIAN}] })
              .level_moves([[1, :MUDSLAP], [2, :POISONSTING], [4, :HARDEN], [7, :FAIRYWIND], [11, :MUDBOMB], [16, :HIDDENPOWER], [22, :ACIDARMOR], [29, :BODYSLAM], [37, :STRANGESTEAM], [46, :RECOVER]])
              .egg_moves([])
              .compatible_moves([:AFTERYOU, :ALLYSWITCH, :AMNESIA, :ARENITEWALL, :BLOCK, :BODYSLAM, :BRINE, :BULLDOZE, :DAZZLINGGLEAM, :DELUGE, :DIG, :DRAININGKISS, :EARTHPOWER, :EARTHQUAKE, :ENDEAVOR, :FAKETEARS, :FLASH, :GASTROACID, :GRAVITY, :HYPERVOICE, :INFESTATION, :LIGHTSCREEN, :MAGICCOAT, :MISTYEXPLOSION, :MISTYTERRAIN, :MUDSHOT, :NATUREPOWER, :PLAYROUGH, :POWERGEM, :RAINDANCE, :RECYCLE, :REFLECT, :ROCKBLAST, :ROCKSLIDE, :ROCKTOMB, :SAFEGUARD, :SANDSTORM, :SANDTOMB, :SCORCHINGSANDS, :SCREECH, :SHADOWBALL, :SHOCKWAVE, :SKILLSWAP, :SUNNYDAY, :TERRAINPULSE, :VENOMDRENCH, :WEATHERBALL, :DELUGE, :IRRITATION, :MUDBARRAGE])
  ...
  GASTRODON_WEST_AEVIAN = PokeModifier.add_form(:GASTRODON, "West Aevian Form")
              ...
              .abilities({0 => :STORMDRAIN, 1 => :LIQUIDOOZE, 2 => :POISONHEAL})
              .set_ev([2, 0, 0, 0, 0, 0])
              .set_preevo(proc { {:species => :SHELLOS, :form => SHELLOS_WEST_AEVIAN} })
  ...
  GASTRODON_EAST_AEVIAN = PokeModifier.add_form(:GASTRODON, "East Aevian Form")
              ...
              .abilities({0 => :STORMDRAIN, 1 => :LIQUIDOOZE, 2 => :FLAREBOOST})
              .set_ev([2, 0, 0, 0, 0, 0])
              .set_preevo(proc { {:species => :SHELLOS, :form => SHELLOS_EAST_AEVIAN} })
              .level_moves([[1, :MUDSLAP], [1, :POISONSTING], [1, :HARDEN], [1, :FAIRYWIND], [2, :POISONSTING], [4, :HARDEN], [7, :FAIRYWIND], [11, :MUDBOMB], [16, :HIDDENPOWER], [22, :ACIDARMOR], [29, :BODYSLAM], [41, :STRANGESTEAM], [54, :RECOVER]])
              .egg_moves([])
              .compatible_moves([:AFTERYOU, :ALLYSWITCH, :AMNESIA, :ARENITEWALL, :ASSURANCE, :BLOCK, :BODYPRESS, :BODYSLAM, :BRINE, :BULLDOZE, :DAZZLINGGLEAM, :DELUGE, :DIG, :DRAININGKISS, :EARTHPOWER, :EARTHQUAKE, :ENDEAVOR, :FAKETEARS, :FIREBLAST, :FLAMETHROWER, :FLASH, :GASTROACID, :GIGAIMPACT, :GRAVITY, :GUNKSHOT, :HIGHHORSEPOWER, :HYPERBEAM, :HYPERVOICE, :INFESTATION, :LIGHTSCREEN, :MAGICCOAT, :MISTYEXPLOSION, :MISTYTERRAIN, :MUDSHOT, :MYSTICALFIRE, :NATUREPOWER, :PLAYROUGH, :POWERGEM, :RAINDANCE, :RECYCLE, :REFLECT, :ROCKBLAST, :ROCKCLIMB, :ROCKSLIDE, :ROCKTOMB, :SAFEGUARD, :SANDTOMB, :SANDSTORM, :SCORCHINGSANDS, :SCREECH, :SHADOWBALL, :SHOCKWAVE, :SKILLSWAP, :SLUDGEBOMB, :SLUDGEWAVE, :STRENGTH, :SUNNYDAY, :TERRAINPULSE, :VENOMDRENCH, :VENOSHOCK, :WEATHERBALL, :DELUGE, :IRRITATION, :MUDBARRAGE])
  ...
  BRONZOR_AEVIAN = PokeModifier.add_form(:BRONZOR, "Aevian Form")
              ...
              .set_ev([0, 0, 1, 0, 0, 0])
              .set_evolutions(proc { [{:species => :BRONZONG, :method => :Level, :parameter => 33, :form => BRONZONG_AEVIAN}] })
  ...
  BRONZONG_AEVIAN = PokeModifier.add_form(:BRONZONG, "Aevian Form")
              ...
              .abilities({0 => :REFLECTOR, 1 => nil, 2 => :REFLECTOR})
              .set_ev([0, 0, 1, 0, 1, 0])
              .set_preevo(proc { {:species => :BRONZOR, :form => BRONZOR_AEVIAN} })
  ...
  FROSLASS_AEVIAN = PokeModifier.add_form(:FROSLASS, "Aevian Form")
              ...
              .abilities({0 => :ADAPTABILITY, 2 => :GOOEY})
              .set_ev([0, 0, 0, 0, 0, 2])
              .set_preevo(proc { {:species => :SNORUNT, :form => SNORUNT_AEVIAN} })
  ...
  MUNNA_AEVIAN = PokeModifier.add_form(:MUNNA, "Aevian Form")
              ...
              .set_ev([1, 0, 0, 0, 0, 0])
              .set_evolutions(proc { [{:species => :MUSHARNA, :method => :Item, :parameter => :NIGHTMAREFUEL, :form => MUSHARNA_AEVIAN}] })
  ...
  MUSHARNA_AEVIAN = PokeModifier.add_form(:MUSHARNA, "Aevian Form")
              ...
              .abilities({0 => :BADDREAMS, 1 => :SHEDSKIN, 2 => :TOUGHCLAWS})
              .set_ev([2, 0, 0, 0, 0, 0])
              .set_preevo(proc { {:species => :MUNNA, :form => MUNNA_AEVIAN} })
  ...
  SEWADDLE_AEVIAN = PokeModifier.add_form(:SEWADDLE, "Aevian Form")
              ...
              .set_ev([0, 0, 1, 0, 0, 0])
              .set_evolutions(proc { [{:species => :SWADLOON, :method => :Level, :parameter => 20, :form => SWADLOON_AEVIAN}] })
  ...
  SWADLOON_AEVIAN = PokeModifier.add_form(:SWADLOON, "Aevian Form")
              ...
              .abilities({0 => :SWARM, 1 => :UNNERVE, 2 => :INTIMIDATE})
              .set_ev([0, 0, 2, 0, 0, 0])
              .set_evolutions(proc { [{:species => :LEAVANNY, :method => :HasMove, :parameter => :DRAGONCLAW, :form => LEAVANNY_AEVIAN}] })
              .set_preevo(proc { {:species => :SEWADDLE, :form => SEWADDLE_AEVIAN} })
  ...
  LEAVANNY_AEVIAN = PokeModifier.add_form(:LEAVANNY, "Aevian Form")
              ...
              .abilities({0 => :SWARM, 1 => :UNNERVE, 2 => :INTIMIDATE})
              .set_ev([0, 3, 0, 0, 0, 0])
              .set_preevo(proc { {:species => :SWADLOON, :form => SWADLOON_AEVIAN} })
  ...
  SIGILYPH_AEVIAN = PokeModifier.add_form(:SIGILYPH, "Aevian Form")
              ...
              .abilities({0 => :FLAREBOOST, 1 => :MAGICGUARD, 2 => :TINTEDLENS})
              .set_ev([0, 0, 0, 2, 0, 0])
  ...
  LITWICK_AEVIAN = PokeModifier.add_form(:LITWICK, "Aevian Form")
              ...
              .set_ev([0, 0, 0, 1, 0, 0])
              .set_evolutions(proc { [{:species => :LAMPENT, :method => :HasMove, :parameter => :ZAPCANNON, :form => LAMPENT_AEVIAN}] })
  ...
  LAMPENT_AEVIAN = PokeModifier.add_form(:LAMPENT, "Aevian Form")
              ...
              .set_ev([0, 0, 0, 2, 0, 0])
              .set_evolutions(proc { [{:species => :CHANDELURE, :method => :Item, :parameter => :THUNDERSTONE, :form => CHANDELURE_AEVIAN}] })
              .set_preevo(proc { {:species => :LITWICK, :form => LITWICK_AEVIAN} })
  ...
  CHANDELURE_AEVIAN = PokeModifier.add_form(:CHANDELURE, "Aevian Form")
              ...
              .abilities({0 => :ILLUMINATE, 1 => :VOLTABSORB, 2 => :LEVITATE})
              .set_ev([0, 0, 0, 3, 0, 0])
              .set_preevo(proc { {:species => :LAMPENT, :form => LAMPENT_AEVIAN} })
  ...
  LARVESTA_AEVIAN = PokeModifier.add_form(:LARVESTA, "Aevian Form")
              ...
              .set_ev([0, 1, 0, 0, 0, 0])
              .set_evolutions(proc { [{:species => :VOLCARONA, :method => :Level, :parameter => 59, :form => VOLCARONA_AEVIAN}] })
  ...
  VOLCARONA_AEVIAN = PokeModifier.add_form(:VOLCARONA, "Aevian Form")
              ...
              .set_ev([0, 0, 0, 3, 0, 0])
              .set_preevo(proc { {:species => :LARVESTA, :form => LARVESTA_AEVIAN} })
  ...
  WIMPOD_AEVIAN = PokeModifier.add_form(:WIMPOD, "Aevian Form")
              ...
              .set_ev([0, 0, 0, 0, 0, 1])
              .set_evolutions(proc { [{:species => :GOLISOPOD, :method => :Level, :parameter => 30, :form => GOLISOPOD_AEVIAN}] })
  ...
  GOLISOPOD_AEVIAN = PokeModifier.add_form(:GOLISOPOD, "Aevian Form")
              ...
              .set_ev([0, 0, 2, 0, 0, 0])
              .set_preevo(proc { {:species => :WIMPOD, :form => WIMPOD_AEVIAN} })
    ...
    SANDYGAST_ROCKY_AEVIAN = PokeModifier.add_form(:SANDYGAST, "Rocky Aevian Form")
              .level_moves_overwrite
              .egg_moves_overwrite
              .compatible_moves_overwrite
              .types({:Type1 => :GHOST, :Type2 => :ROCK})
              .abilities({0 => :CLEARBODY, 1 => :STORMDRAIN, 2 => :CLEARBODY})
              .set_evolutions(proc { [{:species => :PALOSSAND, :method => :Level, :parameter => 42, :form => PALOSSAND_ROCKY_AEVIAN}] })
              .level_moves([[1, :HARDEN], [1, :ABSORB], [5, :ASTONISH], [9, :STEALTHROCK], [14, :ROCKBLAST], [18, :MEGADRAIN], [23, :ROCKTOMB], [27, :HYPNOSIS], [32, :IRONDEFENSE], [36, :GIGADRAIN], [41, :SHADOWBALL], [45, :POWERGEM], [50, :MORNINGSUN], [54, :SANDSTORM]])
              .egg_moves([:AMNESIA, :ANCIENTPOWER, :CAMOUFLAGE, :CURSE, :DESTINYBOND, :SPITUP, :STOCKPILE, :SWALLOW])
              .compatible_moves([:AFTERYOU, :AMNESIA, :BLOCK, :BRINE, :BULLDOZE, :DREAMEATER, :ENERGYBALL, :EXPLOSION, :GIGADRAIN, :GRASSKNOT, :GRAVITY, :HEX, :IRONDEFENSE, :LASERFOCUS, :NATUREPOWER, :PAINSPLIT, :POWERGEM, :PSYCHIC, :RECYCLE, :ROCKBLAST, :ROCKPOLISH, :ROCKSLIDE, :ROCKTOMB, :ROLEPLAY, :SANDSTORM, :SELFDESTRUCT, :SHADOWBALL, :SKILLSWAP, :SLUDGEWAVE, :SMACKDOWN, :SPITE, :STEALTHROCK, :STONEEDGE, :TAUNT, :TERRAINPULSE, :TRICK, :WATERPULSE, :ARENITEWALL, :MUDBARRAGE])
              .set_dex_entry("After floods from Route 5's river drove it into Mt. Valor, it has adapted to the whims of the mountain. The mood crystal particles it carries allow it to change forms.")
              .asset_override(asset: "UniLib/Assets/Battlers/sandygast-rocky_aevian.png", asset_egg: "UniLib/Assets/Battlers/sandygast-rocky_aevian_egg.png", icon: "UniLib/Assets/Icons/sandygast-rocky_aevian.png", icon_egg: "UniLib/Assets/Icons/sandygast-rocky_aevian_egg.png")
              .get_form

  SANDYGAST_FIERY_AEVIAN = PokeModifier.add_form(:SANDYGAST, "Fiery Aevian Form")
              .level_moves_overwrite
              .egg_moves_overwrite
              .compatible_moves_overwrite
              .types({:Type1 => :GHOST, :Type2 => :FIRE})
              .abilities({0 => :FLAMEBODY, 1 => :STEAMENGINE, 2 => :FLAMEBODY})
              .set_evolutions(proc { [{:species => :PALOSSAND, :method => :Level, :parameter => 42, :form => PALOSSAND_FIERY_AEVIAN}] })
              .level_moves([[1, :HARDEN], [1, :ABSORB], [5, :ASTONISH], [9, :WILLOWISP], [14, :FIRESPIN], [18, :MEGADRAIN], [23, :FLAMEBURST], [27, :HYPNOSIS], [32, :IRONDEFENSE], [36, :GIGADRAIN], [41, :SHADOWBALL], [45, :LAVAPLUME], [50, :MORNINGSUN], [54, :SUNNYDAY]])
              .egg_moves([:AMNESIA, :ANCIENTPOWER, :CAMOUFLAGE, :CURSE, :DESTINYBOND, :SPITUP, :STOCKPILE, :SWALLOW])
              .compatible_moves([:AFTERYOU, :AMNESIA, :BLOCK, :BRINE, :BULLDOZE, :ENERGYBALL, :FIREBLAST, :FIRESPIN, :FLAMECHARGE, :FLAMETHROWER, :FOCUSBLAST, :GIGADRAIN, :GRAVITY, :HEATCRASH, :HEATWAVE, :INCINERATE, :IRONDEFENSE, :LASERFOCUS, :MYSTICALFIRE, :OVERHEAT, :PAINSPLIT, :PHANTOMFORCE, :PSYCHIC, :RECYCLE, :ROLEPLAY, :SANDSTORM, :SHADOWBALL, :SHOCKWAVE, :SKILLSWAP, :SOLARBEAM, :SOLARBLADE, :SPITE, :STEALTHROCK, :SUNNYDAY, :TERRAINPULSE, :TRICK, :WILLOWISP, :WORKUP, :MAGMADRIFT])
              .asset_override(asset: "UniLib/Assets/Battlers/sandygast-fiery_aevian.png", asset_egg: "UniLib/Assets/Battlers/sandygast-fiery_aevian_egg.png", icon: "UniLib/Assets/Icons/sandygast-fiery_aevian.png", icon_egg: "UniLib/Assets/Icons/sandygast-fiery_aevian_egg.png")
              .get_form

  SANDYGAST_ICY_AEVIAN = PokeModifier.add_form(:SANDYGAST, "Icy Aevian Form")
              .level_moves_overwrite
              .egg_moves_overwrite
              .compatible_moves_overwrite
              .types({:Type1 => :GHOST, :Type2 => :ICE})
              .abilities({0 => :ICEBODY, 1 => :BULLETPROOF, 2 => :ICEBODY})
              .set_evolutions(proc { [{:species => :PALOSSAND, :method => :Level, :parameter => 42, :form => PALOSSAND_ICY_AEVIAN}] })
              .level_moves([[1, :HARDEN], [1, :ABSORB], [5, :ASTONISH], [9, :HAZE], [14, :ICESHARD], [18, :MEGADRAIN], [23, :AURORABEAM], [27, :HYPNOSIS], [32, :IRONDEFENSE], [36, :GIGADRAIN], [41, :SHADOWBALL], [45, :FREEZEDRY], [50, :MOONLIGHT], [54, :HAIL]])
              .egg_moves([:AMNESIA, :ANCIENTPOWER, :CAMOUFLAGE, :CURSE, :DESTINYBOND, :SPITUP, :STOCKPILE, :SWALLOW])
              .compatible_moves([:AFTERYOU, :AMNESIA, :AURORAVEIL, :AVALANCHE, :BLIZZARD, :BLOCK, :BRINE, :CALMMIND, :ENERGYBALL, :FLASHCANNON, :FROSTBREATH, :GIGADRAIN, :GRAVITY, :GYROBALL, :HAIL, :HEX, :ICEBEAM, :ICICLESPEAR, :ICYWIND, :IRONDEFENSE, :LASERFOCUS, :PAINSPLIT, :PSYCHIC, :RECYCLE, :ROCKPOLISH, :ROLEPLAY, :SHADOWBALL, :SKILLSWAP, :SPITE, :TERRAINPULSE, :THUNDERWAVE, :TRICK, :WHIRLPOOL, :DELUGE])
              .asset_override(asset: "UniLib/Assets/Battlers/sandygast-icy_aevian.png", asset_egg: "UniLib/Assets/Battlers/sandygast-icy_aevian_egg.png", icon: "UniLib/Assets/Icons/sandygast-icy_aevian.png", icon_egg: "UniLib/Assets/Icons/sandygast-icy_aevian_egg.png")
              .get_form

  PALOSSAND_ROCKY_AEVIAN = PokeModifier.add_form(:PALOSSAND, "Rocky Aevian Form")
              .level_moves_overwrite
              .egg_moves_overwrite
              .compatible_moves_overwrite
              .types({:Type1 => :GHOST, :Type2 => :ROCK})
              .abilities({0 => :CLEARBODY, 1 => :SOLIDROCK, 2 => :CLEARBODY})
              .set_preevo(proc { {:species => :SANDYGAST, :form => SANDYGAST_ROCKY_AEVIAN} })
              .level_moves([[1, :HARDEN], [1, :ABSORB], [1, :ASTONISH], [1, :STEALTHROCK], [5, :ASTONISH], [9, :STEALTHROCK], [14, :ROCKBLAST], [18, :MEGADRAIN], [23, :ROCKTOMB], [27, :HYPNOSIS], [32, :IRONDEFENSE], [36, :GIGADRAIN], [41, :SHADOWBALL], [47, :POWERGEM], [57, :RECOVER], [60, :SANDSTORM]])
              .egg_moves([])
              .compatible_moves([:AFTERYOU, :AMNESIA, :ARENITEWALL, :BLOCK, :BRINE, :BULLDOZE, :DREAMEATER, :EMBARGO, :ENERGYBALL, :EXPLOSION, :FLING, :GIGADRAIN, :GIGAIMPACT, :GRASSKNOT, :GRAVITY, :HEX, :HYPERBEAM, :IRONDEFENSE, :LASERFOCUS, :METEORBEAM, :NATUREPOWER, :PAINSPLIT, :POLTERGEIST, :POWERGEM, :PSYCHIC, :QUASH, :RECYCLE, :ROCKBLAST, :ROCKPOLISH, :ROCKSLIDE, :ROCKTOMB, :ROLEPLAY, :SANDSTORM, :SELFDESTRUCT, :SHADOWBALL, :SKILLSWAP, :SLUDGEWAVE, :SMACKDOWN, :SPITE, :STEALTHROCK, :STONEEDGE, :STRENGTH, :TAUNT, :TERRAINPULSE, :TRICK, :WATERPULSE, :ARENITEWALL, :DELUGE, :MUDBARRAGE])
              .set_dex_entry("Palossand uses materials from the ruins within Mt. Valor to fortify itself. It's a mystery where it got the scarf and carrot it has in its Ice form, however.")
              .asset_override(asset: "UniLib/Assets/Battlers/palossand-rocky_aevian.png", icon: "UniLib/Assets/Icons/palossand-rocky_aevian.png")
              .get_form

  PALOSSAND_FIERY_AEVIAN = PokeModifier.add_form(:PALOSSAND, "Fiery Aevian Form")
              .level_moves_overwrite
              .egg_moves_overwrite
              .compatible_moves_overwrite
              .types({:Type1 => :GHOST, :Type2 => :FIRE})
              .abilities({0 => :FLAMEBODY, 1 => :STEAMENGINE, 2 => :FLAMEBODY})
              .set_preevo(proc { {:species => :SANDYGAST, :form => SANDYGAST_FIERY_AEVIAN} })
              .level_moves([[1, :HARDEN], [1, :ABSORB], [5, :ASTONISH], [9, :WILLOWISP], [5, :ASTONISH], [9, :WILLOWISP], [14, :FIRESPIN], [18, :MEGADRAIN], [23, :FLAMEBURST], [27, :HYPNOSIS], [32, :IRONDEFENSE], [36, :GIGADRAIN], [41, :SHADOWBALL], [47, :LAVAPLUME], [57, :MORNINGSUN], [60, :SUNNYDAY]])
              .egg_moves([])
              .compatible_moves([:AFTERYOU, :AMNESIA, :BLOCK, :BRINE, :BULLDOZE, :BURNINGJEALOUSY, :EMBARGO, :ENERGYBALL, :FIREBLAST, :FIRESPIN, :FLAMECHARGE, :FLAMETHROWER, :FLING, :FOCUSBLAST, :GIGADRAIN, :GIGAIMPACT, :GRAVITY, :HEATCRASH, :HEATWAVE, :HYPERBEAM, :INCINERATE, :IRONDEFENSE, :LASERFOCUS, :MAGMADRIFT, :MYSTICALFIRE, :OVERHEAT, :PAINSPLIT, :PHANTOMFORCE, :POLTERGEIST, :PSYCHIC, :QUASH, :RECYCLE, :ROLEPLAY, :SANDSTORM, :SHADOWBALL, :SHOCKWAVE, :SKILLSWAP, :SOLARBEAM, :SOLARBLADE, :SPITE, :STEALTHROCK, :STRENGTH, :SUNNYDAY, :TERRAINPULSE, :TRICK, :WILLOWISP, :WORKUP, :MAGMADRIFT])
              .asset_override(asset: "UniLib/Assets/Battlers/palossand-fiery_aevian.png", icon: "UniLib/Assets/Icons/palossand-fiery_aevian.png")
              .get_form

  PALOSSAND_ICY_AEVIAN = PokeModifier.add_form(:PALOSSAND, "Icy Aevian Form")
              .level_moves_overwrite
              .egg_moves_overwrite
              .compatible_moves_overwrite
              .types({:Type1 => :GHOST, :Type2 => :ICE})
              .abilities({0 => :ICEBODY, 1 => :BULLETPROOF, 2 => :ICEBODY})
              .set_preevo(proc { {:species => :SANDYGAST, :form => SANDYGAST_ICY_AEVIAN} })
              .level_moves([[1, :HARDEN], [1, :ABSORB], [1, :ASTONISH], [1, :HAZE], [5, :ASTONISH], [9, :HAZE], [14, :ICESHARD], [18, :MEGADRAIN], [23, :AURORABEAM], [27, :HYPNOSIS], [32, :IRONDEFENSE], [36, :GIGADRAIN], [41, :SHADOWBALL], [47, :FREEZEDRY], [57, :MOONLIGHT], [60, :HAIL]])
              .egg_moves([])
              .compatible_moves([:AFTERYOU, :AMNESIA, :AURORAVEIL, :AVALANCHE, :BLIZZARD, :BLOCK, :BRINE, :CALMMIND, :EMBARGO, :ENERGYBALL, :FLASHCANNON, :FLING, :FROSTBREATH, :GIGADRAIN, :GIGAIMPACT, :GRAVITY, :GYROBALL, :HAIL, :HEX, :HYPERBEAM, :ICEBEAM, :ICICLESPEAR, :ICYWIND, :IRONDEFENSE, :LASERFOCUS, :PAINSPLIT, :POLTERGEIST, :PSYCHIC, :QUASH, :RECYCLE, :RETURN, :ROCKPOLISH, :ROLEPLAY, :SHADOWBALL, :SKILLSWAP, :SLEEPTALK, :SPITE, :STRENGTH, :TERRAINPULSE, :THUNDERWAVE, :TRICK, :TRIPLEAXEL, :WHIRLPOOL, :DELUGE])
              .asset_override(asset: "UniLib/Assets/Battlers/palossand-icy_aevian.png", icon: "UniLib/Assets/Icons/palossand-icy_aevian.png")
              .get_form
  ...
  JANGMOO_AEVIAN = PokeModifier.add_form(:JANGMOO, "Aevian Form")
              ...
              .set_ev([0, 0, 1, 0, 0, 0])
              .set_evolutions(proc { [{:species => :HAKAMOO, :method => :Level, :parameter => 35, :form => HAKAMOO_AEVIAN}] })
  ...
  HAKAMOO_AEVIAN = PokeModifier.add_form(:HAKAMOO, "Aevian Form")
              ...
              .abilities({0 => :ANALYTIC, 1 => :KEENEYE, 2 => :OVERCOAT})
              .set_ev([0, 0, 2, 0, 0, 0])
              .set_evolutions(proc { [{:species => :KOMMOO, :method => :Level, :parameter => 45, :form => KOMMOO_AEVIAN}] })
              .set_preevo(proc { {:species => :JANGMOO, :form => JANGMOO_AEVIAN} })
  ...
  KOMMOO_AEVIAN = PokeModifier.add_form(:KOMMOO, "Aevian Form")
              ...
              .set_ev([0, 0, 3, 0, 0, 0])
              .set_preevo(proc { {:species => :HAKAMOO, :form => HAKAMOO_AEVIAN} })
  ...
  class PokeBattle_Move_20C < PokeBattle_Move
    ...
    def pbNumHits(attacker)
      @move == :GILDEDHELIX ? 2 : 1
    end

    def pbShowAnimation(id, attacker, opponent, hitnum = 0, alltargets = nil, showanimation = true)
      @battle.pbAnimation(:SACREDSWORD, attacker, opponent, hitnum) if showanimation
    end
  end
